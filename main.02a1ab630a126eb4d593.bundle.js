...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sjcl__ = __webpack_require__("koeK");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sjcl___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_sjcl__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_bitcore_lib__ = __webpack_require__("nVvX");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_bitcore_lib_cash__ = __webpack_require__("x8nq");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_crypto_wallet_core__ = __webpack_require__("w4S4");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_crypto_wallet_core___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_crypto_wallet_core__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_bitcore_mnemonic__ = __webpack_require__("OGkG");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_bitcore_mnemonic___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_bitcore_mnemonic__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash__ = __webpack_require__("xrDH");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_common_http__ = __webpack_require__("XKz0");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rxjs_add_operator_catch__ = __webpack_require__("xpf9");
...
var RecoveryService = /** @class */ (function () {
    ...
    RecoveryService.prototype.fromBackup = function (data, m, n, coin, network) {
        ...
        if (coin !== 'eth') {
            ...
            var xpriv = __WEBPACK_IMPORTED_MODULE_2_bitcore_lib__["HDPrivateKey"](key.xPrivKey);
    ...
    RecoveryService.prototype.checkAngularCryptoConfig = function () {
        ...
        try {
            new __WEBPACK_IMPORTED_MODULE_5_bitcore_mnemonic__(mnemonics).toHDPrivateKey('', 'testnet').toString();
        }
        catch (ex) {
            console.log(ex);
    ...
    RecoveryService.prototype.fromMnemonic = function (data, m, n, coin, network) {
        ...
        var words = __WEBPACK_IMPORTED_MODULE_6_lodash__["trim"](data.backup);
        var passphrase = data.password;
        var xPriv;
        try {
            if (coin !== 'eth') {
                xPriv = new __WEBPACK_IMPORTED_MODULE_5_bitcore_mnemonic__(words).toHDPrivateKey(passphrase, network).toString();
            }
            else {
                var xpriv = new __WEBPACK_IMPORTED_MODULE_5_bitcore_mnemonic__(words).toHDPrivateKey(passphrase, network);
                var path = this.bitcore.Deriver.pathFor(coin.toUpperCase(), network);
                xPriv = xpriv.deriveChild(path).toString();
            }
        }
    ...
    RecoveryService.prototype.buildWallet = function (credentials) {
        var result;
        credentials = __WEBPACK_IMPORTED_MODULE_6_lodash__["compact"](credentials);
        if (credentials.length === 0) {
            throw new Error('No data provided');
        }
        if (__WEBPACK_IMPORTED_MODULE_6_lodash__["uniq"](__WEBPACK_IMPORTED_MODULE_6_lodash__["map"](credentials, 'from')).length !== 1) {
            throw new Error('Mixed backup sources not supported');
        }
        // tslint:disable-next-line:max-line-length
        result = __WEBPACK_IMPORTED_MODULE_6_lodash__["pick"](credentials[0], ['walletId', 'derivationStrategy', 'addressType', 'm', 'n', 'network', 'from', 'coin', 'publicKeyRing']);
        // only for backup files
        result.copayers = __WEBPACK_IMPORTED_MODULE_6_lodash__["map"](credentials, function (c) {
        ...
        if (result.from === 'backup') {
            if (__WEBPACK_IMPORTED_MODULE_6_lodash__["uniq"](__WEBPACK_IMPORTED_MODULE_6_lodash__["compact"](__WEBPACK_IMPORTED_MODULE_6_lodash__["map"](result.copayers, 'copayerId'))).length !== result.copayers.length) {
    ...
    RecoveryService.prototype.getWallet = function (data, m, n, coin, network) {
        ...
        if (coin === 'btc') {
            ...
            this.bitcore = __WEBPACK_IMPORTED_MODULE_4_crypto_wallet_core__;
        }
        else {
            throw new Error('Unknown coin ' + coin);
        }
        var credentials = __WEBPACK_IMPORTED_MODULE_6_lodash__["map"](data, function (dataItem) {
            dataItem.backup = __WEBPACK_IMPORTED_MODULE_6_lodash__["trim"](dataItem.backup);
    ...
    RecoveryService.prototype.scanWallet = function (wallet, coin, inGap, account, reportFn, cb) {
        ...
        this.getActiveAddresses(wallet, inGap, account, reportFn, function (err, addresses) {
            ...
            utxos = __WEBPACK_IMPORTED_MODULE_6_lodash__["flatten"](__WEBPACK_IMPORTED_MODULE_6_lodash__["map"](addresses, 'utxo'));
            var result = {
                addresses: __WEBPACK_IMPORTED_MODULE_6_lodash__["uniq"](addresses),
                balance: coin === 'bsv' ? __WEBPACK_IMPORTED_MODULE_6_lodash__["sumBy"](utxos, 'amount') : __WEBPACK_IMPORTED_MODULE_6_lodash__["sumBy"](addresses, 'balance'),
            };
    ...
    RecoveryService.prototype.getPaths = function (wallet, account) {
        if (wallet.derivationStrategy === 'BIP45') {
            var p = __WEBPACK_IMPORTED_MODULE_6_lodash__["clone"](this.PATHS[wallet.derivationStrategy]);
    ...
    RecoveryService.prototype.getPathsWithAccount = function (wallet, account) {
        var paths = __WEBPACK_IMPORTED_MODULE_6_lodash__["cloneDeep"](this.PATHS);
            ...
            var combine = function (g1, g2) {
                ...
                for (var i = 0; i < g1.length; i++) {
                    for (var j = 0; j < g2.length; j++) {
                        combinations.push(__WEBPACK_IMPORTED_MODULE_6_lodash__["flatten"]([g1[i], g2[j]]));
                    }
                }
                return combinations;
            };
            return combine(groups[0], expand(__WEBPACK_IMPORTED_MODULE_6_lodash__["tail"](groups)));
        };
        var xPrivKeys = __WEBPACK_IMPORTED_MODULE_6_lodash__["map"](wallet.copayers, 'xPriv');
        var derivations = [];
        __WEBPACK_IMPORTED_MODULE_6_lodash__["each"](this.getPaths(wallet, account), function (path) {
            var derivation = expand(__WEBPACK_IMPORTED_MODULE_6_lodash__["map"](xPrivKeys, function (xpriv, i) {
    ...
    RecoveryService.prototype.getActiveAddresses = function (wallet, inGap, account, reportFn, cb) {
        ...
        var exploreDerivation = function (i) {
            if (i >= baseDerivations.length) {
                return cb(null, __WEBPACK_IMPORTED_MODULE_6_lodash__["uniqBy"](activeAddress, 'address'));
            }
            inactiveCount = 0;
        ...
        var derive = function (baseDerivation, index, callback) {
            ...
            _this.checkAddressData(address, wallet.coin, wallet.network, function (err, addressData) {
                ...
                if (!__WEBPACK_IMPORTED_MODULE_6_lodash__["isEmpty"](addressData)) {
                ...
                reportFn(inactiveCount, __WEBPACK_IMPORTED_MODULE_6_lodash__["uniqBy"](activeAddress, 'address'));
    ...
    RecoveryService.prototype.generateAddress = function (wallet, derivedItems, index) {
        ...
        __WEBPACK_IMPORTED_MODULE_6_lodash__["each"]([].concat(derivedItems), function (derivedItem) {
            if (wallet.coin !== 'eth') {
                ...
                if (wallet.publicKeyRing && wallet.coin) {
                    ...
                    var isChange_1 = parseInt(__WEBPACK_IMPORTED_MODULE_6_lodash__["last"](path_1).toString(), 10);
                    derivedPublicKeys = [];
                    wallet.publicKeyRing.forEach(function (item) {
                        if (wallet.derivationStrategy === 'BIP45') {
                            // (sharedId = 2147483647 )
                            var copayerId = parseInt(__WEBPACK_IMPORTED_MODULE_6_lodash__["nth"](path_1, -2).toString(), 10);
    ...
    RecoveryService.prototype.checkEthAddress = function (address, coin, network, cb) {
        var _this = this;
    ...
    RecoveryService.prototype.checkAddress = function (address, coin, network, cb) {
        ...
        this.getAddressTxos(addr, coin, network).subscribe(function (txos) {
            var utxos = __WEBPACK_IMPORTED_MODULE_6_lodash__["filter"](txos, ['spentHeight', -2]);
            var addressData = {
                address: addr,
                balance: __WEBPACK_IMPORTED_MODULE_6_lodash__["sumBy"](utxos, 'value'),
                utxo: utxos,
                privKeys: address.privKeys,
                pubKeys: address.pubKeys,
                info: address.info,
    ...
    RecoveryService.prototype.createRawTx = function (toAddress, scanResults, wallet, fee) {
        if (wallet.coin !== 'eth') {
            ...
            try {
                ...
                __WEBPACK_IMPORTED_MODULE_6_lodash__["each"](scanResults.addresses, function (address) {
                    if (address.utxo.length > 0) {
                        __WEBPACK_IMPORTED_MODULE_6_lodash__["each"](address.utxo, function (u) {
                            if (wallet.coin !== 'bsv') {
                                u.txid = u.mintTxid;
                ...
                tx_1.sign(__WEBPACK_IMPORTED_MODULE_6_lodash__["uniq"](privKeys_1));
            ...
            var amount = parseInt((balance - fee * 1e18).toFixed(0), 10);
            if (amount <= 0) {
                throw new Error('Funds are insufficient to complete the transaction');
            }
            console.log('Generating a ' + wallet.coin + ' transaction');
            ...
            try {
                var tx = this.bitcore.Transactions.create({
                ...
                var rawEthTx = this.bitcore.Transactions.sign({
                    chain: wallet.coin.toUpperCase(),
                    tx: tx,
                    key: key
                });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_common_http__ = __webpack_require__("XKz0");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("/oeL");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser_dynamic__ = __webpack_require__("Qa4U");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_app_module__ = __webpack_require__("aR8+");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__environments_environment__ = __webpack_require__("p5Ee");
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("/oeL");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash__ = __webpack_require__("xrDH");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_services_recovery_service__ = __webpack_require__("6kpM");
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.processInputs = function () {
        ...
        var reportFn = function (currentGap, activeAddresses) {
            ...
            var balStr = _this.wallet.coin === 'eth' ? (balance * 1e-18).toFixed(8) + ' ' : balance.toFixed(8) + ' ';
    ...
    AppComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_5" /* Component */])({
            ...
            styles: [__webpack_require__("W675")],
